...
class ViewNotebookTestCase(TestCase):
    def setUp(self):
        ...
        test_notebook_2 = Notebook.objects.create(
            name_notebook="TestNotebook_2", iduser="1"
        )
    ...
    def test_viewes_user_notebooks(self):
        ...
        self.assertEqual(
            list(notebook.values_list("name_notebook")),
            [("TestNotebook",), ("TestNotebook_2",)],
        )
    ...
    def test_create_notebook_delete_notebook(self):
        ...
        c.force_login(user)
        response = c.post(
            "/accounts/addnotebook", {"name_notebook": "TestNotebookCreate"}
        )
